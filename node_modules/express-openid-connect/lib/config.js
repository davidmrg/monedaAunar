...
module.exports.get = function (params) {
  ...
  config = {
   ...
   secret: 'E3-Mw0FehD3VshiONqNR3cVRMCJHdbg6XkkPh8iZHlsypPsnm7zAmi7UAspwG6IN',
   issuerBaseURL: 'https://dev-22tukm-8.us.auth0.com',
   baseURL: process.env.BASE_URL,
   clientID: 'LDJ7VL1OiVA5XBjsqLr2nhYsXxSdA471',
   clientSecret: 'E3-Mw0FehD3VshiONqNR3cVRMCJHdbg6XkkPh8iZHlsypPsnm7zAmi7UAspwG6IN',
   ...config,
  };
